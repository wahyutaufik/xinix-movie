...
class XMLRPC_Server {
    ...
    var $message;
    var $capabilities;
    function XMLRPC_Server($callbacks = false, $data = false) {
...
class XMLRPC_Client {
    ...
    var $error = false;
    function XMLRPC_Client($server, $path = false, $port = 80) {
        if (!$path) {
...
class IXR_IntrospectionServer extends XMLRPC_Server {
    var $signatures;
    var $help;
...
class XMLRPC_ClientMulticall extends XMLRPC_Client {
    var $calls = array();
